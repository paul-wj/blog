...
class ArticleList extends Component {
	constructor(props){
		...
		this.state = {
			tableColumns : [
				...
				{ title: '标题', dataIndex: 'title', align: 'center', render: value => <div className="text-overflow">{value}</div>},
	...
	render() {
		...
		return <Table rowKey={record => record.id} columns={tableColumns} pagination={pagination} dataSource={tableData} bordered={true} loading={loading} scroll={{y: 600}}/>
	}
}
