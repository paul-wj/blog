...
const MemoArticleReplyList = memo(ArticleReplyList);

const ArticleCommentList: FC<ArticleCommentProps> = ({id}: ArticleCommentProps): ReactElement => {
